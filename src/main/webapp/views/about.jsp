...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
    ...
    <section class="mb-16 text-center">
        <h2 class="text-4xl md:text-5xl font-bold text-blue-700 mb-6">Chúng tôi là ai?</h2>
        ...
        <img src="https://images.unsplash.com/photo-1581090700227-1e8e8d1e8e2b?auto=format&fit=crop&w=1350&q=80" alt="Đội ngũ TechZone" class="rounded-lg shadow-lg w-full max-w-4xl mx-auto max-h-[450px] object-cover mb-8 border border-gray-200">
    ...
    <section class="mb-16 bg-white p-8 rounded-lg shadow-md border border-gray-200">
        <h2 class="text-3xl font-semibold text-gray-900 mb-4 text-center">Sứ Mệnh Của Chúng Tôi</h2>
    ...
    <section class="grid md:grid-cols-2 gap-8">
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
            <h3 class="text-xl font-semibold text-blue-600 mb-3">Phần Cứng Cao Cấp</h3>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
            <h3 class="text-xl font-semibold text-blue-600 mb-3">Đổi Mới Công Nghệ</h3>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
            <h3 class="text-xl font-semibold text-blue-600 mb-3">Hỗ Trợ Khách Hàng</h3>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-shadow duration-300">
            <h3 class="text-xl font-semibold text-blue-600 mb-3">Trách Nhiệm Môi Trường</h3>
